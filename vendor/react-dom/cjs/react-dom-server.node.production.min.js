...
function zc(a,b,c){var d=b.blockedSegment.formatContext,e=b.legacyContext,g=b.context;try{return Z(a,b,c)}catch(l){if(ec(),"object"===typeof l&&null!==l&&"function"===typeof l.then){c=l;var f=b.blockedSegment,h=X(a,f.chunks.length,null,f.formatContext);f.children.push(h);a=tc(a,b.node,b.blockedBoundary,h,b.abortSet,b.legacyContext,b.context,b.assignID);b.assignID=null;a=a.ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=e;b.context=g;P(g)}else throw b.blockedSegment.formatContext=
d,b.legacyContext=e,b.context=g,P(g),l;}}function Ac(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;Bc(this,b,a)}
...
function Bc(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(n(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(b=a.onReadyToStream,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Ac,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed&&1===c.status){var d=b.completedSegments;
d.push(c);1===d.length&&b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onCompleteAll,a())}
function sc(a){if(2!==a.status){var b=N,c=oc.current;oc.current=nc;var d=mc;mc=a.responseState;try{var e=a.pingedTasks,g;for(g=0;g<e.length;g++){var f=e[g];var h=a,l=f.blockedSegment;if(0===l.status){P(f.context);try{Z(h,f,f.node),f.abortSet.delete(f),l.status=1,Bc(h,f.blockedBoundary,l)}catch(t){if(ec(),"object"===typeof t&&null!==t&&"function"===typeof t.then){var m=f.ping;t.then(m,m)}else{f.abortSet.delete(f);l.status=4;var p=f.blockedBoundary,r=t;Y(h,r);null===p?uc(h,r):(p.pendingTasks--,p.forceClientRender||
(p.forceClientRender=!0,p.parentFlushed&&h.clientRenderedBoundaries.push(p)));h.allPendingTasks--;if(0===h.allPendingTasks){var E=h.onCompleteAll;E()}}}finally{}}}e.splice(0,g);1===a.status&&Dc(a)}catch(t){Y(a,t),uc(a,t)}finally{mc=d,oc.current=c,c===nc&&P(b)}}}
...
b.flush(),0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.end()}}}function Kc(a){setImmediate(function(){return sc(a)})}function Lc(a){if(2!==a.status){a.status=1;try{Dc(a)}catch(b){Y(a,b),uc(a,b)}}}function Mc(a,b){return function(){return Lc(b)}}
...
void 0,l=c?c.onReadyToStream:void 0;c=[];var m=new Set;b={destination:b,responseState:d,progressiveChunkSize:void 0===g?12800:g,status:0,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:m,pingedTasks:c,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===f?pc:f,onCompleteAll:void 0===h?qc:h,onReadyToStream:void 0===l?qc:l};d=X(b,0,null,e);d.parentFlushed=!0;a=tc(b,a,null,d,m,Sb,null,null);c.push(a);return b}
exports.pipeToNodeWritable=function(a,b,c){var d=Nc(a,b,c),e=!1;Kc(d);return{startWriting:function(){e||(e=!0,Lc(d),b.on("drain",Mc(b,d)))},abort:function(){try{var a=d.abortableTasks;a.forEach(Cc,d);a.clear();1===d.status&&Dc(d)}catch(f){Y(d,f),uc(d,f)}}}};exports.version="17.0.3";
