...
function lb(){throw Error(n(394));}function mb(){throw Error(n(393));}function nb(){}
var ob={readContext:function(a){return a._currentValue2},useContext:function(a){S();return a._currentValue2},useMemo:kb,useReducer:ib,useRef:function(a){L=S();N=fb();var b=N.memoizedState;return null===b?(a={current:a},N.memoizedState=a):b},useState:function(a){return ib(hb,a)},useLayoutEffect:function(){},useCallback:function(a,b){return kb(function(){return a},b)},useImperativeHandle:nb,useEffect:nb,useDebugValue:nb,useDeferredValue:function(a){S();return a},useTransition:function(){S();return[!1,
lb]},useOpaqueIdentifier:function(){var a=T;if(null===a)throw Error(n(404));return a.opaqueIdentifierPrefix+(a.nextOpaqueID++).toString(36)},useMutableSource:function(a,b){S();return b(a._source)},getCacheForType:function(){throw Error(n(248));},useCacheRefresh:function(){return mb}},T=null,pb=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;function qb(a){console.error(a)}function rb(){}
function sb(a,b,c,d,e,g,f,k){var l=[],m=new Set;b={destination:b,responseState:c,progressiveChunkSize:void 0===e?12800:e,status:0,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:m,pingedTasks:l,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===g?qb:g,onCompleteAll:void 0===f?rb:f,onReadyToStream:void 0===k?rb:k};d=U(b,0,null,d);d.parentFlushed=!0;a=tb(b,a,null,d,m,Va,null,null);l.push(a);return b}
function tb(a,b,c,d,e,g,f,k){a.allPendingTasks++;null===c?a.pendingRootTasks++:c.pendingTasks++;var l={node:b,ping:function(){var b=a.pingedTasks;b.push(l);1===b.length&&ub(a)},blockedBoundary:c,blockedSegment:d,abortSet:e,legacyContext:g,context:f,assignID:k};e.add(l);return l}function U(a,b,c,d){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],formatContext:d,boundary:c}}function V(a,b){a=a.onError;a(b)}function W(a,b){a.status=2;a.destination.destroy(b)}
function vb(a,b,c,d,e){L={};for(a=c(d,e);P;)P=!1,R+=1,N=null,a=c(d,e);gb();return a}function wb(a,b,c,d){var e=c.render(),g=d.childContextTypes;if(null!==g&&void 0!==g){var f=b.legacyContext;if("function"!==typeof c.getChildContext)d=f;else{c=c.getChildContext();for(var k in c)if(!(k in g))throw Error(n(108,Ua(d)||"Unknown",k));d=h({},f,c)}b.legacyContext=d;X(a,b,e);b.legacyContext=f}else X(a,b,e)}
function xb(a,b){if(a&&a.defaultProps){b=h({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}
function yb(a,b,c,d,e){if("function"===typeof c)if(c.prototype&&c.prototype.isReactComponent){e=Wa(c,b.legacyContext);var g=c.contextType;g=new c(d,"object"===typeof g&&null!==g?g._currentValue2:e);bb(g,c,d,e);wb(a,b,g,c)}else e=Wa(c,b.legacyContext),g=vb(a,b,c,d,e),"object"===typeof g&&null!==g&&"function"===typeof g.render&&void 0===g.$$typeof?(bb(g,c,d,e),wb(a,b,g,c)):X(a,b,g);else if("string"===typeof c){e=b.blockedSegment;g=za(e.chunks,c,d,a.responseState,e.formatContext,b.assignID);b.assignID=
...
4,V(a,p),l.forceClientRender=!0}finally{b.blockedBoundary=c,b.blockedSegment=g}g=l.id;null!==g&&A(f.chunks,a.responseState,g);g=U(a,f.chunks.length,null,f.formatContext);f.status=1;f.children.push(g);b=tb(a,e,c,g,d,b.legacyContext,b.context,null);a.pingedTasks.push(b)}return}if("object"===typeof c&&null!==c)switch(c.$$typeof){case La:d=vb(a,b,c.render,d,e);X(a,b,d);return;case Oa:c=c.type;d=xb(c,d);yb(a,b,c,d,e);return;case Ja:e=d.children;c=c._context;d=d.value;g=c._currentValue2;c._currentValue2=
...
function Y(a,b,c){var d=b.blockedSegment.formatContext,e=b.legacyContext,g=b.context;try{return X(a,b,c)}catch(l){if(gb(),"object"===typeof l&&null!==l&&"function"===typeof l.then){c=l;var f=b.blockedSegment,k=U(a,f.chunks.length,null,f.formatContext);f.children.push(k);a=tb(a,b.node,b.blockedBoundary,k,b.abortSet,b.legacyContext,b.context,b.assignID);b.assignID=null;a=a.ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=e;b.context=g;K(g)}else throw b.blockedSegment.formatContext=
d,b.legacyContext=e,b.context=g,K(g),l;}}function zb(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;Ab(this,b,a)}
function Bb(a){var b=a.blockedBoundary;a.blockedSegment.status=3;null===b?(this.allPendingTasks--,2!==this.status&&(this.status=2,this.destination.push(null))):(b.pendingTasks--,b.forceClientRender||(b.forceClientRender=!0,b.parentFlushed&&this.clientRenderedBoundaries.push(b)),b.fallbackAbortableTasks.forEach(Bb,this),b.fallbackAbortableTasks.clear(),this.allPendingTasks--,0===this.allPendingTasks&&(a=this.onCompleteAll,a()))}
function Ab(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(n(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(b=a.onReadyToStream,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(zb,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed&&1===c.status){var d=b.completedSegments;
d.push(c);1===d.length&&b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onCompleteAll,a())}
function ub(a){if(2!==a.status){var b=I,c=pb.current;pb.current=ob;var d=T;T=a.responseState;try{var e=a.pingedTasks,g;for(g=0;g<e.length;g++){var f=e[g];var k=a,l=f.blockedSegment;if(0===l.status){K(f.context);try{X(k,f,f.node),f.abortSet.delete(f),l.status=1,Ab(k,f.blockedBoundary,l)}catch(t){if(gb(),"object"===typeof t&&null!==t&&"function"===typeof t.then){var m=f.ping;t.then(m,m)}else{f.abortSet.delete(f);l.status=4;var p=f.blockedBoundary,r=t;V(k,r);null===p?W(k,r):(p.pendingTasks--,p.forceClientRender||
(p.forceClientRender=!0,p.parentFlushed&&k.clientRenderedBoundaries.push(p)));k.allPendingTasks--;if(0===k.allPendingTasks){var E=k.onCompleteAll;E()}}}finally{}}}e.splice(0,g);1===a.status&&Cb(a)}catch(t){V(a,t),W(a,t)}finally{T=d,pb.current=c,c===ob&&K(b)}}}
...
a.completedBoundaries;for(e=0;e<t.length;e++)if(!Fb(a,b,t[e])){a.status=0;e++;t.splice(0,e);return}t.splice(0,e)}finally{Hb=!1,0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.push(null)}}}function Ib(a){if(2!==a.status){a.status=1;try{Cb(a)}catch(b){V(a,b),W(a,b)}}}function Jb(a){try{var b=a.abortableTasks;b.forEach(Bb,a);b.clear();1===a.status&&Cb(a)}catch(c){V(a,c),W(a,c)}}function Kb(){}
function Lb(a,b,c){var d=!1,e=null,g="",f=!1;a=sb(a,{push:function(a){null!==a&&(g+=a);return!0},destroy:function(a){d=!0;e=a}},Ca(c,b?b.identifierPrefix:void 0),Da(),Infinity,Kb,void 0,function(){f=!0});ub(a);Jb(a);Ib(a);if(d)throw e;if(!f)throw Error(n(342));return g}
var Mb=function(a){function b(){var b=a.call(this,{})||this;b.request=null;b.startedFlowing=!1;return b}ca(b,a);var c=b.prototype;c._destroy=function(a,b){Jb(this.request);b(a)};c._read=function(){this.startedFlowing&&Ib(this.request)};return b}(ba.Readable);function Nb(){}function Ob(a,b){var c=new Mb,d=sb(a,c,Ca(!1,b?b.identifierPrefix:void 0),Da(),Infinity,Nb,function(){c.startedFlowing=!0;Ib(d)},void 0);c.request=d;ub(d);return c}exports.renderToNodeStream=function(a,b){return Ob(a,b)};
exports.renderToStaticMarkup=function(a,b){return Lb(a,b,!0)};exports.renderToStaticNodeStream=function(a,b){return Ob(a,b)};exports.renderToString=function(a,b){return Lb(a,b,!1)};exports.version="17.0.3";
