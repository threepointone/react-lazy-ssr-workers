...
b){return g.current.useMemo(a,b)};b.useReducer=function(a,b,d){return g.current.useReducer(a,b,d)};b.useRef=function(a){return g.current.useRef(a)};b.useState=function(a){return g.current.useState(a)};b.useTransition=function(){return g.current.useTransition()};b.version="17.0.3"});
})();
